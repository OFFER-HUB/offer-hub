...
export class DlqProcessor extends WorkerHost {
    ...
    async process(job: Job<{
        ...
        // DLQ jobs are primarily for inspection - we log them for alerting
        ...
        // await this.alertingService.sendDlqAlert(job.data);
    ...
    onFailed(job: Job, error: Error) {
        // This should rarely happen since DLQ processing just logs
